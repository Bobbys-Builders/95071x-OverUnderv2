...
void skillsPreauton() {
    ...
    driveMode = 2;
    maxTurnSpeed = 600;
    swerve(4*24, 12, swervePID2, 2000, 500);
    botMove(4, 300);
...
//    while(t < 18000) {
    ...
    driveMode = 1;
    setTargetPos(1*24+8, 3*24-12, 270);
    ...
    setTargetPos(1*24+20, 5*24+16, 90);
    setChainPos(12, 4*24+12);
    maxMoveSpeed = 600;
    untilTargetPos(15, 2000);
    setChainPos(1*24+20, 5*24+16);
    boomerAng = true;
    maxMoveSpeed = 450;
