...
void closeElimAuton2() {
    ...
    intake.moveVelocity(-600); // push ball over barrier
    driveDisabled = true;
...
void farSafeAuton() {
    ...
    botMove(-5, 450);
    pros::delay(200);
    intake.moveVelocity(600); // intake triball 1
    botMove(10, 450);
    pros::delay(100);
    botMove(-5, 450);
    driveDisabled = false;
    ...
    intake.moveVelocity(600); // intake triball 3
...
void farSafe6Auton() {
    ...
    intake.moveVelocity(600); // intake triball 4
...
void skillsSegA() {
    ...
    intake.moveVelocity(-600); // ram in triballs
    // wings.extBLWing();
    kicker.target = 170;
    driveDisabled = true;
