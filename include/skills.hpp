...
void skillsAuton() {
    ...
    // setTargetPos(xPos+200, yPos+160);
    // maxMoveSpeed = 250;
    // maxMoveSpeed = 0;
    ...
    driveMode = 1;
    setTargetPos(1*24+12, 3*24+16);
    setChainPos(1*24+12, 4*24+12);
    maxMoveSpeed = 0;
    untilTargetH(10, 2000);
    intake.moveVelocity(200);
    maxMoveSpeed = 450;
    untilTargetPos(15, 2000);
    setChainPos(1*24+12, 3*24+16);
    maxMoveSpeed = 300;
